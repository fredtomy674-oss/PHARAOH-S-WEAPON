...
> آخر تحديث: 2026-09-25 — التنفيذ في `server/test/` (Vitest **353/353**)، الويب يُفحص بنيويًا + E2E بالمتصفح **40/40**.
...
npm run e2e                       # يشغّل كل شيء تلقائيًا (خادمان مُداران + 40 اختبارًا)
