...
> آخر تحديث: 2026-09-25 — التنفيذ في `server/test/` (Vitest **258/258**)، الويب يُفحص بنيويًا + E2E بالمتصفح **34/34**.
...
> آخر تحديث: 2026-09-25 — **34/34 أخضر** عبر `npm run e2e`. الاختبارات حقيقية 100%: متصفح Chromium → React SPA → Vite proxy → Fastify → SQLite → RAG → AI provider (mock=افتراضي المشروع) → persistence → المتصفح.
